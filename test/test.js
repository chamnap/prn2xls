...
// var PrnParser = require('../invoice_parser');

// describe('#PrnParser, multiple pages', function() {
...
//     var parser = PrnParser(contents[0]).attributes;

//     console.log(parser);
//   });
// });

// // describe('#PrnParser, single page', function() {
// //   var path = __dirname + '/support/one_page.PRN';
